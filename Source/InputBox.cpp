...
#define		CIB_WIDTH 200
#define		CIB_HEIGHT 70
...
CIB_DECL CIB_CONSTRUCTOR(CIB_OBJ HINSTANCE hInst)
{
	...
	this->hwndInputBox = CreateWindow(	CIB_CLASS_NAME, "",
					WS_POPUPWINDOW, rect.left+(rect.right-rect.left-CIB_WIDTH)/2,
...
void	CIB_DECL create(CIB_OBJ HWND hwndNew)
{
	...
	this->hwndEditBox = CreateWindow("Edit", "", WS_CHILD | WS_VISIBLE | WS_BORDER | ES_AUTOHSCROLL | ES_LEFT, 7,
							20, CIB_WIDTH-CIB_LEFT_OFFSET*3, CIB_BTN_HEIGHT,
							this->hwndInputBox,	NULL,
							this->hThisInstance, NULL);
	this->hwndOk =		CreateWindow("Button", "Save", WS_CHILD | WS_VISIBLE | WS_TABSTOP | BS_PUSHBUTTON,
							70, 45,
